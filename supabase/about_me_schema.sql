-- About Me Section Database Schema
...
CREATE TABLE IF NOT EXISTS about_me (
  ...
  highlight_1_title TEXT DEFAULT 'AI, Cloud & Research',
  highlight_1_description TEXT DEFAULT 'Bridging intelligent systems with real-world impact.',
  highlight_2_title TEXT DEFAULT 'Continuous learning',
  highlight_2_description TEXT DEFAULT 'Driven by collaboration, innovation, and community initiatives.',
